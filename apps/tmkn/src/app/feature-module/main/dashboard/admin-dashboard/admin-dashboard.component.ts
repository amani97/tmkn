...
import { ApexAxisChartSeries, ApexChart, ApexDataLabels, ApexGrid, ApexPlotOptions, ApexStroke, ApexXAxis, ChartComponent, NgApexchartsModule } from 'ng-apexcharts';
