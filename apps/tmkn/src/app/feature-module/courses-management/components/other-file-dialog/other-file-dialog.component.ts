...
@Component({
  selector: 'app-other-file-dialog',
  standalone: false,
  templateUrl: './other-file-dialog.component.html',
  styleUrl: './other-file-dialog.component.scss',
})
export class OtherFileFormDialogComponent implements OnInit {
  ...
  onSubmit() {
    ...
    data = {
      ...data,
      type: MediaContentType.OtherFiles,
    };
    if (this.isEditMode) {
